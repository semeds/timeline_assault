...
public class MAssaultRiflePickup extends NPC {
   ...
   public MAssaultRiflePickup(Point location, Map map) {
       super(location.x, location.y, new SpriteSheet(ImageLoader.load("drumgun.png"), 40, 40), "DEFAULT");
       isActive = true;
