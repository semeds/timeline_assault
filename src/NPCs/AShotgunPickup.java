...
public class AShotgunPickup extends NPC {
   ...
   public AShotgunPickup(Point location, Map map) {
       super(location.x, location.y, new SpriteSheet(ImageLoader.load("apocalypse_shotty.png"), 40, 40), "DEFAULT");
       isActive = true;
