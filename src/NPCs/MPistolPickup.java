...
public class MPistolPickup extends NPC {
   ...
   public MPistolPickup(Point location, Map map) {
       super(location.x, location.y, new SpriteSheet(ImageLoader.load("modern_pistol.png"), 40, 40), "DEFAULT");
       isActive = true;
