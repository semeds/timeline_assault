...
public class FAssaultRiflePickup extends NPC {
   ...
   public FAssaultRiflePickup(Point location, Map map) {
       super(location.x, location.y, new SpriteSheet(ImageLoader.load("future_ar.png"), 40, 40), "DEFAULT");
       isActive = true;
