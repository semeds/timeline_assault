...
public class FPistolPickup extends NPC {
   ...
   public FPistolPickup(Point location, Map map) {
       super(location.x, location.y, new SpriteSheet(ImageLoader.load("future_pistol.png"), 40, 40), "DEFAULT");
       isActive = true;
