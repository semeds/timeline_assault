...
public class FShotgunPickup extends NPC {
   ...
   public FShotgunPickup(Point location, Map map) {
       super(location.x, location.y, new SpriteSheet(ImageLoader.load("future_shotty.png"), 40, 40), "DEFAULT");
       isActive = true;
