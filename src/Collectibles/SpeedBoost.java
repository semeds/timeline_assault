...
public class SpeedBoost extends NPC {

    protected Map mapPosition;

    public SpeedBoost(Point location, Map map) {
        super(location.x, location.y, new SpriteSheet(ImageLoader.load("speedboost.png"), 24, 24), "DEFAULT");
        isInteractable = true;
